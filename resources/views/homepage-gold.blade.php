    ...
    <section>
        <div class="card" style="margin-top: 4.3rem;">
            <div class="bg-image">
                ...
                {{-- <div class="mask" style="background-color: hsla(144, 100%, 36%, 0.6)"></div> --}}
            </div>
            ...
            <div class="card-img-overlay align-items-center">
                ...
                @if ((int)$hour[0] < 12)
                    <div class="d-flex w-100 justify-content-between">
                        <div class="badge text-wrap me-2 rounded-pill" style="background-color: #C6A961; width: 4.5rem; height: 1.5rem">
                            <a class="text-white m-0 p-0 align-middle text-decoration-none" href="/greenlevel">Gold</a>
                        </div>
                        <h5 class="card-title m-0"> Good Morning, </h5>
                    </div>
                    <h1 class="card-title text-end">Mr. Vico Lamar!</h1>
        ...
        {{-- STAR SECTION --}}
        <div class="mx-4 mt-4 rounded" style="background-color: #E6D8B1; height: max-content;">
            ...
            <div class="row">
                <div class="col-9">
                    <p id="stars-info" class="mb-0 pb-3 align-middle" style="padding-left: 1.2rem; font-size: 0.8em;">
                        You have collected <span class="fw-bold" style="font-size: 1.3em; color: #977D35;">30</span> stars so far. Collect more to redeem more rewards.
                    </p>
                </div>
        ...
        <div class="position-fixed bottom-0 end-0" style="margin-bottom: 5rem; margin-right: 2rem;">
            <a href="/coffeelist" class="btn text-white" style="background-color: #C6A961">Coffee</a>
        </div>
    </section>

    {{-- FOOTER --}}
    <section>
        <footer class="text-white text-center text-md-start" style="background-color: #C6A961">
